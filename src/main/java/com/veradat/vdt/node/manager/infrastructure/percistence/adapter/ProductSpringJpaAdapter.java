...
import com.veradat.vdt.node.manager.infrastructure.percistence.repository.NodeMappingRepository;
...
public class ProductSpringJpaAdapter implements PersistencePort {
    ...
    @Override
    public void persistNodeMappings(List<Mapping> nodeMappings, String createdBy) throws VeradatException {
        ...
        for (Mapping nodeMappingPersistence : nodeMappings) {
            ...
            nodeMappingEntity.setCreatedAt(Instant.now());
